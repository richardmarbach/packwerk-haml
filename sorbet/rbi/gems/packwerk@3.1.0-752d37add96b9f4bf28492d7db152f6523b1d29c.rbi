...
module Packwerk::FileParser
  ...
  # @abstract
  #
  # source://packwerk//lib/packwerk/file_parser.rb#31
  ...
  class << self
    # source://packwerk//lib/packwerk/file_parser.rb#21
    sig { returns(T::Array[::Packwerk::FileParser]) }
    def all; end

    # source://packwerk//lib/packwerk/file_parser.rb#16
    sig { params(base: ::Class).void }
    def included(base); end

    # source://packwerk//lib/packwerk/file_parser.rb#26
    sig { params(base: ::Class).void }
    def remove(base); end
  end
end
