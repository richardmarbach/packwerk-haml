...
class M::Frameworks
  # source://m//lib/m/frameworks.rb#27
  ...
  # @return [Boolean]
  #
  # source://m//lib/m/frameworks.rb#49
  def test_unit?; end

  class << self
    # source://m//lib/m/frameworks.rb#23
    def framework_runner; end

    # @return [Boolean]
    #
    # source://m//lib/m/frameworks.rb#15
    def minitest4?; end

    # @return [Boolean]
    #
    # source://m//lib/m/frameworks.rb#11
    def minitest5?; end
    ...
    # @return [Boolean]
    #
    # source://m//lib/m/frameworks.rb#19
    def test_unit?; end
  end
end
...
class M::Parser
  ...
  #
  # source://m//lib/m/parser.rb#55
  def argv; end

  # source://m//lib/m/parser.rb#57
...
class M::Runners::Minitest5 < ::M::Runners::Base
  # source://m//lib/m/runners/minitest_5.rb#9
  def run(test_arguments); end

  # source://m//lib/m/runners/minitest_5.rb#4
  def suites; end

  # source://m//lib/m/runners/minitest_5.rb#15
  def test_methods(suite_class); end
end
